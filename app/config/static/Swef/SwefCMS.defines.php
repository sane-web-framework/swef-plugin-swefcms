...
// Files
define ( 'swefcms_file_dash',                       __DIR__.'/SwefCMS.dash.html'                );
define ( 'swefcms_file_option_collections',         __DIR__.'/SwefCMS.o.collections.html'       );
define ( 'swefcms_file_option_collection',          __DIR__.'/SwefCMS.o.collection.html'        );
define ( 'swefcms_file_option_item',                __DIR__.'/SwefCMS.o.item.html'              );
define ( 'swefcms_file_option_markdown',            __DIR__.'/SwefCMS.o.markdown.html'          );
